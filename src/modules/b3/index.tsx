...
export default function B3() {
  return (
    <div className="text-white py-16 px-5 lg:px-20">
            ...
            <div className="flex flex-col gap-5 text-base font-font-2">
              <div className="flex flex-row items-start gap-2">
                ...
                <div className="text-justify">
                  ...
                  Traditional data industries, including our past Web2 ventures,
                  excluded users from the value they generated, while cat
                  rescues in war zones lack sustainable funding. Users’ data
                  fueled corporate profits, and rescue efforts often lacked
                  transparency.
                </div>
              </div>
              <div className="flex flex-row items-start gap-2">
                ...
                <div className="text-justify">
                  ...
                  tokens for sharing anonymized data, sold ethically to cat food
                  corporations. Blockchain ensures transparent donation
        ...
        <div>
          <div>
            ...
            <div className="text-base font-font-2 text-justify">
              ...
              serving Fortune 500 clients, establishes trust. Unlike speculative
              crypto projects, we offer a tangible mission—saving cats—backed by
              audited smart contracts (CoinSult, SOLIDProof) and GDPR-compliant
              data practices. Our experience ensures scalable, reliable
              execution, making Pet Fund a dependable choice for investors and
              pet lovers alike.
            </div>
          </div>
          <div className="mt-10">
            ...
            <div className="text-base font-font-2 text-justify">
              ...
              Partnerships with nonprofit organizations reinforce our dedication
              to making a difference, not just a profit.
            </div>
          </div>
        </div>
      </div>
