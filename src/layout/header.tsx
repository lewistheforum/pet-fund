...
export default function Header() {
  ...
  const memoizedHomeSection = useMemo(
    () => (
      <div className="col-span-12 lg:col-span-6 relative flex flex-col justify-start pt-0 lg:pt-36 pb-10 lg:pb-0 px-5 lg:px-0 lg:pr-14 gap-5">
        <>
          <motion.div
            className="w-full lg:w-3/4 mx-auto border border-[#4AA76C] rounded-xl shadow-2xl px-8 py-6 font-sans"
            initial="initial"
            animate="animate"
            exit="exit"
          ...
          <motion.div
            className="w-full lg:w-3/4 mx-auto bg-white rounded-xl shadow-2xl p-8 font-sans"
            initial="initial"
            animate="animate"
            exit="exit"
            variants={sectionTransitionVariants}
  ...
  const memoizedHomeContent = useMemo(
    () => (
      <div className="col-span-12 lg:col-span-6 mx-auto relative px-5 lg:pr-24 py-10 pt-36">
        <motion.div
  ...
  return (
    <div className="font-font-2">
      <div>
        ...
        >
          <motion.div className="flex flex-row items-center justify-between px-5 lg:px-20 py-3 bg-white">
            {/* Logo */}
            <motion.div
        ...
        <div className="relative grid grid-cols-12">
          ...
          {selectedOption === 4 && (
            <div className="col-span-12 lg:col-span-6 mx-auto relative px-5 lg:pr-24 py-10 pt-36 h-full">
              <motion.div
                initial="initial"
                animate="animate"
                exit="exit"
